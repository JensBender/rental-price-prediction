...
+ Visualized property locations on an [interactive map of Singapore](https://jensbender.github.io/rental-price-prediction/map.html) using Python's Folium library. 
